                ...
                <div className="flex gap-y-6 flex-wrap">
                    ...
                    <div className="bg-gray-200/70 rounded-xl px-8 py-8 w-full flex gap-y-4 flex-wrap">
                        <div className="relative w-full">
                            <p className="text-sm text-gray-300 font-bold">Display Name</p>
                            <p className="font-semibold font-mono ">{user.name}</p>
                        </div>
                        <div className="relative w-full">
                            <p className="text-sm text-gray-300 font-bold">Email Id</p>
                            <p className="font-semibold font-mono ">{user.email}</p>
                        </div>
                        <div className="relative w-full">
                            <p className="text-sm text-gray-300 font-bold">Phone Number</p>
